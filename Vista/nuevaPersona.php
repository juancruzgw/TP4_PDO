...
<div class="container contenedor rounded shadow mb-3">
    ...
    <form id="formularioCrearPersona" method="post" action="../Vista/Action/accionCrearPersona.php" id="formulario">
            ...
            <div class="form-group mt-4">
                ...
                <div><input type="number" name="NroDni" id="NroDni" class="form-control"></div>
            </div>
            
            <div class="form-group mt-4">
                <label for="fechaNac" style="color: #2196F3;font-size: 20px;">Ingrese una fecha de nacimiento</label>
                <div><input type="date" name="fechaNac" id="fechaNac" class="form-control"></div>
            </div>
            
            <div class="form-group mt-4">
                <label for="Telefono" style="color: #2196F3;font-size: 20px;">Ingrese un teléfono</label>
                <div><input type="number" name="Telefono" id="Telefono" class="form-control"></div>
            </div>

            <div class="form-group mt-4">
                <label for="Domicilio" style="color: #2196F3;font-size: 20px;">Ingrese un domicilio</label>
                <div><input type="text"  name="Domicilio" id="Domicilio" class="form-control"></div>
            </div>
