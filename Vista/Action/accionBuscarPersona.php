...
try {
   if (is_numeric($datos['NroDni'])) {
      ...
      if ($persona = $abmPersona->obtenerDatos($datos)) {
            ...
            echo "<form action='../Action/ActualizarDatosPersona.php' method='post'";
         ...
         throw new Exception("<div class='modalDatosIncorrectos' style='font-weight: bold;'> No existe la persona </div>");
      }

   } else {
      throw new Exception("<div class='modalDatosIncorrectos' style='font-weight: bold;'>El dni debe ser un numero</div>");
   }
